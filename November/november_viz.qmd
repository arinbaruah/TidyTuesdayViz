...
ggplot(ratings_long %>% filter(Field == "Average rating"),aes(y = Brand, x = Value,fill = Value)) + geom_col() + geom_vline(xintercept = 7.5, linetype = "dotted") + geom_text(aes(label = round(Value,1)),color = "white",) +
  facet_wrap(~Field,nrow = 1,scales = "free_x") + scale_fill_continuous(type = "gradient",low = "#132B43",
  high = "#AF9ACD",)
```
