...
ggplot(ratings_long %>% filter(Field == "Average rating"),aes(y = Brand, x = Value,fill = Value)) + geom_col() + facet_wrap(~Field,nrow = 1,scales = "free_x") + scale_fill_continuous(type = "gradient",low = "#132B43",
  high = "#AF9ACD",)
```
