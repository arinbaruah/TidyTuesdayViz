...
negative_result <- c("Disqualified","Bottom","Not Chosen","Bottom three (Males)","Bottom 2",
                     "Bottom 3","Bottom three","Bottom Three","Bottom three (Female)","Bottom three (Males)","Bottom two","Bottom Two","Bottom two (Female)","Bottom two (Males)","Eliminated","Eliminated (6th)","Top 3/Eliminated")
