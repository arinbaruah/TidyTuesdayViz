...
ggplot(summer_movie_cats, aes(id = genres,area = Total)) +
  geom_circlepack() +
  geom_circlepack_text(aes(label = genres, family = "text", fontface = "bold")) +
  geom_circlepack_text(aes(y = after_stat(y - 2), label = str_wrap(Total, 8), family = "text",color = "white", 
