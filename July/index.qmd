...
subtitle_text <- "The dimensions of a dataset can indicate important characteristics of a dataset. Datasets with much more number of observations than variables <br> are termed as __long datasets__ while those with sizeable number of variables are termed as __wide datasets__."
...
gr =  tt_datasets_long  %>% drop_na() |>
    ...
    geom_vline(xintercept = c(6, 15), linewidth = .3, linetype = "dotted", lineend = "round") +
