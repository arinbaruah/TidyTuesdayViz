...
ggplot(data = summer_movies_number,aes(x = year,y = Total)) + geom_area()
```
```{r}
ggplot(data = summer_movies,aes(x = average_rating)) + geom_density()
```
...
ggplot(summer_movies, aes(id = original_title, area = average_rating)) +
  geom_circlepack() + geom_circlepack_text(aes(label = original_title, color = if_else(num_votes > 2500, "white", "black")), fontface = "bold") 
#   # geom_circlepack_text(aes(label = str_wrap(original_title, 8),color = if_else(average_rating > 8.5, "white", NA)), family = "text", fontface = "bold", lineheight = 0.7, alpha = 0.8)
# 
# ggplot(summer_movies, aes(id = original_title, area = average_rating)) +
#   geom_circlepack() + 
#   geom_circlepack_text(aes(label = average_rating, color = if_else(average_rating > 8.5, "white", "black")), fontface = "bold")
```
