...
title_text <- "How large are the datasets in the TidyTuesdayR repository ?"
...
caption_text <- str_glue("{li} Arindam Baruah | {X_icon} @wizsights | {gh} arinbaruah | #rstudio #gg_waffle #ggplot2")
...
variable_waffle <- ggplot(data = ratio_df,aes(fill = status, values = n)) +
